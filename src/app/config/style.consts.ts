...
export const STYLE: Record<string, string> = {
  ...
  BUTTON: 'w-full sm:w-auto rounded px-3 py-2 text-sm text-white text-center transition-colors cursor-pointer bg-zinc-900 hover:bg-zinc-700',
  BUTTON_OPERATIVE:
    'w-full sm:w-auto rounded px-3 py-2 text-sm text-white text-center transition-colors cursor-pointer bg-zinc-900 hover:bg-zinc-700',
  BUTTON_DESTRUCTIVE:
    'w-full sm:w-auto rounded px-3 py-2 text-sm text-white text-center transition-colors cursor-pointer bg-danger hover:bg-red-700',
};
